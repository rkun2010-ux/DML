...
All settings are identical to Part A, with the exception that we set **$\epsilon \sim \mathcal{N}(0, 1)$** and **$\epsilon' \sim \mathcal{N}(0, 3^2)$** to simulate a high-noise setting.
