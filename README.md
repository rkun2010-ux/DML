...
Numerical evidence shows that the finite-sample performances of the proposed methods are satisfactory. The estimators exhibit average biases near zero; the ESEs closely align with the SSDs, ensuring coverage probabilities reach the nominal 95% level. Furthermore, as sample size increases from 500 to 1000, both SSDs and ESEs decrease, reflecting the robustness of the proposed method. We conclude that the method is insensitive to the selection of machine learning algorithms for estimating $G_0$ or $f_0$.

---

## D. High-noise Settings
